      ...
      <div className="wrapper">
          ...
          {skills.map((skill) => (
            <div key={skill.id} className="skill">
              <img
               ...
               />
              <h2>{skill.name}</h2>
              <button onClick={() => handleLevelClick(skill.id, skill.level)}>
                Level: {skill.level}
              </button>
        ...
        {showLevelModal && (
          <div className="modal">
            <div className="modal-content">
              <h2>Editar Nível</h2>
              <button onClick={() => handleLevelChange('Iniciante')}>Iniciante</button>
              <button onClick={() => handleLevelChange('Intermediário')}>Intermediário</button>
              <button onClick={() => handleLevelChange('Avançado')}>Avançado</button>
              <button onClick={() => setShowLevelModal(false)}>Cancelar</button>
            </div>
          </div>
        )}
